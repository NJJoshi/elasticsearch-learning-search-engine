package com.nj.learning.elasticsearch.elasticsearchspringbootapp.service;

import co.elastic.clients.elasticsearch._types.aggregations.StringTermsAggregate;


import com.nj.learning.elasticsearch.elasticsearchspringbootapp.dto.*;
import com.nj.learning.elasticsearch.elasticsearchspringbootapp.util.Constants;
import com.nj.learning.elasticsearch.elasticsearchspringbootapp.util.NativeQueryBuilder;
...
import static com.nj.learning.elasticsearch.elasticsearchspringbootapp.util.Constants.Business.OFFERINGS_AGGREGATE_NAME;
...
public class SearchService {
    ...
    private Facet buildFacet(String name, StringTermsAggregate stringTermsAggregate) {
        var facetItems = stringTermsAggregate.buckets()
                .array()
                .stream()
                .map(b -> new FaceItem(b.key().stringValue(), b.docCount()))
                .toList();
